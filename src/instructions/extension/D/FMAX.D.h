...
#ifndef RISCV_FMAX_D_H
#define RISCV_FMAX_D_H

#include "../../Instruction.h"

namespace instructions {
    class FMAX_D : public Instruction {
    public:
        FMAX_D(const decode::instruction_type &decoded, registers reg) : Instruction(decoded, reg) {
            sprintf(disas_buffer, "FMAX.D %s, %s, %s",
