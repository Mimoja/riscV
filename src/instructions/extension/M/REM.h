...
namespace instructions {
    ...
    public:
        REM(const decode::instruction_type &decoded, registers reg) : Instruction(decoded, reg) {
            sprintf(disas_buffer, "REM %s, %s, %s", reg.gp.getRegisterName(instr.R.rd),
        ...
        void execute(registers* reg, memory* mem) {
            ...
            if(val2 == 0) reg->gp.setReg32Value(instr.R.rd, val1);
                ...
                reg->gp.setReg32Value(instr.R.rd, 0);
